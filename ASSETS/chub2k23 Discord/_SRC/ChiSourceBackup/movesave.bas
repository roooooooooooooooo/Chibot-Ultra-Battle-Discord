...
Dim Rx%
  ...
  Open Fil$ For Input As 36
    ...
    Input #36, Senshi(x1).Moves(X).Status.Scarecrow
    Input #36, Senshi(x1).Moves(X).Status.Charm
    Input #36, Senshi(x1).Moves(X).Status.R1
    Input #36, Senshi(x1).Moves(X).Status.R2
...
Sub SaveMove (ByVal Fil$, ByVal x1%, ByVal X%)
  ...
  Open Fil$ For Output As 37
    ...
    Write #37, Senshi(x1).Moves(X).Status.Scarecrow
    Write #37, Senshi(x1).Moves(X).Status.Charm
    Write #37, Senshi(x1).Moves(X).Status.R1
    Write #37, Senshi(x1).Moves(X).Status.R2
