...
Private Sub cmdNoBattle_Click()
  Send ccBold + ccUnderline + ccColor + "~~~--->> BATTLE'S OVER!!! <<---~~"
End Sub

Private Sub cmdNoScrolling_Click()
  Send ccBold + ccUnderline + ccColor + "~~~--->>> NO FLOODING!!! <<<---~~~"
End Sub

Private Sub cmdNoSelect_Click()
  Send ccBold + ccUnderline + ccColor + "~~~--->>> SELECTION'S OFF!!! <<<---~~~"
End Sub

Private Sub cmdPaused_Click()
  Send ccBold + ccUnderline + ccColor + "~~~--->>> IT'S PAUSED!!! <<<---~~~"
End Sub

Private Sub cmdRant_Click()
  Send ccBold + ccUnderline + ccColor + "~~~--->>> " + UCase(tRant.Text) + " <<<---~~~"
End Sub

Private Sub cmdSlowDown_Click()
  Send ccBold + ccUnderline + ccColor + "~~~--->>> SLOW DOWN!!! <<<---~~~"
End Sub
