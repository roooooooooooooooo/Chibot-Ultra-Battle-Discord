...
Private Sub mnuRunes_Click()
  If Selection = 1 Then
    ...
    Send ("[.haste] [.str] [.barr] [.regen] [.evade] [.rabbit] [.shoe] [.clover] [.beans]")
    Send ("[.lib] [.undivert] [.magic] [.counter] [.super] [.fatal] [.weird] [.armor] [.pms]")
    Send ("[.heal] [.premonition] [.idiot] [.wonder] [.life] [.theft] [.death] [.learn] [.stealth]")
    Send ("[.reflect] [.summon] [.reraise] [.mute2] [.slot] [.drain] [.respawn] [.jedi] [.pikarune]")
    Send ("[.shadows] [.freeze] [.chubbugs] [.survival] [.thorns] [.acheese] [.spguard] [.desp]")
    Send ("[.spswitch] [.ctrguard] [.chiguard] [.cannibal] [.cancel] [.armory] [.mimic] [.swiss]")
